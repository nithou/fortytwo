...
if(! defined('OPTIPNG_PATH') ) 			define ('OPTIPNG_PATH', '/home8/nithoune/optipng-0.7.1/src/optipng/optipng'); //This will run first because it gives better compression than pngcrush. 
